...
app.use(cors({
    origin: ['http://localhost:3000', 'http://localhost:5173', 'https://adminecomapp.onrender.com', 'https://ecomzone.netlify.app/']
}));
...
app.post("/upload", upload.single('product'), (req, res) => {
    res.json({
        success: 1,
        image_url: `https://adminecomapp.onrender.com/images/${req.file.filename}`
    })
})
